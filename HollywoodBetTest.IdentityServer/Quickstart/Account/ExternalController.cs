...
namespace IdentityServerHost.Quickstart.UI
{
    ...
    public class ExternalController : Controller
    {
        ...
        public ExternalController(
            UserManager<HollywoodBetTestUser> userManager,
            SignInManager<HollywoodBetTestUser> signInManager,
        ...
        private async Task<(HollywoodBetTestUser user, string provider, string providerUserId, IEnumerable<Claim> claims)>
